...
plotCheckerBoard(Weight1Round,"Featur1: SDBP Weight1 Checkerboard");
plotCheckerBoard(Weight2Round,"Featur2: SDBP Weight2 Checkerboard");
...
text(stopIndex*0.8,bias_history(stopIndex*0.8),"bias1(W1-1-1) curve",'Color','k','FontSize',14);
xlabel('Number of Epochs');
ylabel('Value');
...
text(stopIndex*0.8,W1_5_5_history(stopIndex*0.8),"w1(5,5) curve",'Color','m','FontSize',14);

% Plot w1_10_10 curve
plot(1:numel(W1_10_10_history(1:stopIndex)), W1_10_10_history(1:stopIndex), '-c', 'LineWidth', 1);
text(stopIndex*0.8,W1_10_10_history(stopIndex*0.8),"w1(10,10) curve",'Color','c','FontSize',14);

% Plot w1_15_15 curve
plot(1:numel(W1_15_15_history(1:stopIndex)), W1_15_15_history(1:stopIndex), '-r', 'LineWidth', 1);
text(stopIndex*0.8,W1_15_15_history(stopIndex*0.8),"w1(15,15) curve",'Color','r','FontSize',14);

% Plot w2_1_5 curve
plot(1:numel(W2_1_5_history(1:stopIndex)), W2_1_5_history(1:stopIndex), '-g', 'LineWidth', 1);
text(stopIndex*0.8,W2_1_5_history(stopIndex*0.8),"w2(1,5) curve",'Color','g','FontSize',14);

% Plot w2_1_10 curve
plot(1:numel(W2_1_10_history(1:stopIndex)), W2_1_10_history(1:stopIndex), '-b', 'LineWidth', 1);
text(stopIndex*0.8,W2_1_10_history(stopIndex*0.8),"w2(1,10) curve",'Color','b','FontSize',14);
hold off
